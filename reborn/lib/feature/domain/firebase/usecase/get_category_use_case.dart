...
class GetCategoryUseCase implements BaseUseCase<List<FBCategory>, CategorySearchData> {

  final FirebaseCategoryApi _categoryApi = FirebaseCategoryApi();
  @override
  Future<List<FBCategory>> call(final CategorySearchData searchData) async {
    ...
    final List<FBCategory> authors = categoryList.map((e) => e.toEntity()).toList();
    return authors;
  }
}